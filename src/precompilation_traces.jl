...
precompile(Tuple{Type{NamedTuple{(:start_threadid, :disallow_task_migration, :execution_mode), T} where T<:Tuple}, Tuple{Int64, Bool, CooperativeTasks.LoopExecution}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:start_threadid, :disallow_task_migration, :execution_mode), Tuple{Int64, Bool, CooperativeTasks.LoopExecution}}, Type{CooperativeTasks.SpawnOptions}})
