...
precompile(Tuple{CooperativeTasks.var"#_#10#11", Nothing, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, Type{CooperativeTasks.Command}, Function})
...
precompile(Tuple{typeof(Base.convert), Type{ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}}, CooperativeTasks.TaskState})
...
precompile(Tuple{typeof(CooperativeTasks.shutdown_owned_tasks)})
...
precompile(Tuple{typeof(Base.convert), Type{ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}}, Bool})
...
precompile(Tuple{typeof(Base.convert), Type{ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}}, Int64})
...
precompile(Tuple{typeof(Base.setindex!), Base.RefValue{Any}, ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}})
precompile(Tuple{typeof(ResultTypes.iserror), ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}})
precompile(Tuple{typeof(ResultTypes.unwrap), ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}})
...
precompile(Tuple{typeof(ResultTypes.unwrap_error), ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}})
...
precompile(Tuple{typeof(Base.convert), Type{ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}}, CooperativeTasks.Future})
...
precompile(Tuple{typeof(Base.showerror), Base.GenericIOBuffer{Array{UInt8, 1}}, CooperativeTasks.PropagatedTaskException})
precompile(Tuple{typeof(Base.showerror), Base.GenericIOBuffer{Array{UInt8, 1}}, CooperativeTasks.TaskException, Array{Union{Ptr{Nothing}, Base.InterpreterIP}, 1}})
precompile(Tuple{typeof(Base.convert), Type{ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}}, Nothing})
precompile(Tuple{typeof(CooperativeTasks.task_states)})
precompile(Tuple{typeof(Base.convert), Type{ResultTypes.Result{Any, Union{CooperativeTasks.TaskException, CooperativeTasks.ExecutionError}}}, Dictionaries.Dictionary{Task, CooperativeTasks.TaskState}})
